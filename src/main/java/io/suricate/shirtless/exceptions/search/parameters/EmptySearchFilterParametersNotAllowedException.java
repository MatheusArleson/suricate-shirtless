...
/**
 * Exception triggered when either the passed {@link SearchFilterParameters} parameter or associated fallbacks are empty
 ...
 */
public class EmptySearchFilterParametersNotAllowedException extends EmptyParameterNotAllowedException {
	 ...
	 */
	public EmptySearchFilterParametersNotAllowedException(String message) {
		super(message);
	}
